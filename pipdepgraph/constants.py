...
DATABASE_OPERATING_MODE = "database"
RABBITMQ_KPN_OPERATING_MODE = "rmq_kpn"
RABBITMQ_VD_OPERATING_MODE = "rmg_vd"
OPERATING_MODE = os.getenv("OPERATING_MODE", DATABASE_OPERATING_MODE)
