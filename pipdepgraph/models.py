...
class KnownPackageName:
    ...
    def to_json(self) -> str:
        return json.dumps(dict(
            ...
            date_discovered=None if self.date_discovered is None else self.date_discovered.isoformat('T'),
            date_last_checked=None if self.date_last_checked is None else self.date_last_checked.isoformat('T'),
        ))
...
class VersionDistribution:
    ...
    def to_json(self) -> str:
        return json.dumps(dict(
            known_version_id=str(self.known_version_id) if self.known_version_id is not None else None,
            version_distribution_id=str(self.version_distribution_id) if self.version_distribution_id is not None else None,
