...
RABBITMQ_REQS_CAND_CORR_QNAME = "requirements_candidate_correlation"
RABBITMQ_REQS_CAND_CORR_RK_PREFIX = "correlate_candidates.requirement."
RABBITMQ_REQS_CAND_CORR_RK = f"{RABBITMQ_REQS_CAND_CORR_RK_PREFIX}#"
RABBITMQ_REQS_CAND_CORR_SUB_PREFETCH = int(os.getenv("RABBITMQ_REQS_CAND_CORR_SUB_PREFETCH", 100))

RABBITMQ_VERS_CAND_CORR_QNAME = "versions_candidate_correlation"
RABBITMQ_VERS_CAND_CORR_RK_PREFIX = "correlate_candidates.version."
RABBITMQ_VERS_CAND_CORR_RK = f"{RABBITMQ_VERS_CAND_CORR_RK_PREFIX}#"
RABBITMQ_VERS_CAND_CORR_SUB_PREFETCH = int(os.getenv("RABBITMQ_VERS_CAND_CORR_SUB_PREFETCH", 100))

RABBITMQ_CDC_VERSIONS_QNAME = "cdc.versions"
RABBITMQ_CDC_VERSIONS_RK_PREFIX = f"cdc.{table_names.VERSIONS}"
RABBITMQ_CDC_VERSIONS_SUB_PREFETCH = int(os.getenv("RABBITMQ_CDC_VERSIONS_SUB_PREFETCH", 100))

RABBITMQ_CDC_REQS_QNAME = "cdc.requirements"
RABBITMQ_CDC_REQS_RK_PREFIX = f"cdc.{table_names.REQUIREMENTS}"
RABBITMQ_CDC_REQS_SUB_PREFETCH = int(os.getenv("RABBITMQ_CDC_REQS_SUB_PREFETCH", 100))
...
UPL_ONLY_LOAD_UNPROCESSED_DISTRIBUTIONS = bool(
    os.getenv("UPL_ONLY_LOAD_UNPROCESSED_DISTRIBUTIONS", "true").strip().lower() == "true"
)
...
UPL_LOAD_REQUIREMENTS_FOR_CANDIDATE_CORRELATION = bool(
    os.getenv("UPL_LOAD_REQUIREMENTS_FOR_CANDIDATE_CORRELATION", "false").strip().lower() == "true"
)

PACKAGES_REPO_ITER_BATCH_SIZE = int(os.getenv("PACKAGES_REPO_ITER_BATCH_SIZE", "50_000"))
...
CDC_EVENT_LOG_REPO_ITER_BATCH_SIZE = int(os.getenv("CDC_EVENT_LOG_REPO_ITER_BATCH_SIZE", "10_000"))
