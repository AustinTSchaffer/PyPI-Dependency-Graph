...
RABBITMQ_CDC_VERSIONS_STREAM_NAME = "cdc.versions"
RABBITMQ_CDC_VERSIONS_RK = f"cdc.{table_names.VERSIONS}#"

RABBITMQ_CDC_REQS_STREAM_NAME = "cdc.requirements"
RABBITMQ_CDC_REQS_RK = f"cdc.{table_names.REQUIREMENTS}#"
...
CDC_EVENT_LOG_REPO_ITER_BATCH_SIZE = int(os.getenv("CDC_EVENT_LOG_REPO_ITER_BATCH_SIZE", "50_000"))
