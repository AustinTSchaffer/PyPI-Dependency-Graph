...
RABBITMQ_REPROCESS_REQS_QNAME = "requirements_reprocessing"
RABBITMQ_REPROCESS_REQS_RK_PREFIX = "reprocess.requirement."
RABBITMQ_REPROCESS_REQS_RK = f"{RABBITMQ_REPROCESS_REQS_RK_PREFIX}#"
RABBITMQ_REPROCESS_REQS_SUB_PREFETCH = int(os.getenv("RABBITMQ_REPROCESS_REQS_SUB_PREFETCH", 100))
